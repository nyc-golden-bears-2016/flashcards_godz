...
questions4.each do |question, answer|
  Card.create(question: question, answer: answer, deck_id: 4)
end

Deck.create(name: "Riddles")
Deck.create(name: "Enigmas")
Deck.create(name: "Queries")
